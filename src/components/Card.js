...
export default class Card {
  // используется и для загрузки стартовых карточек, и для пользовательских
  constructor(
    {
      name,
      link,
  ...
  generateCard() {
    ...
    this._element.querySelector(
      ".element__like-count"
    ).textContent = this._like.length; // количество лайков при загрузке
  ...
  _isOwnerCard() {
    // если карточка наша, ставим кнопку удаления
