...
export const btnEditAvatar = document.querySelector(
  ".profile__btn-edit-avatar"
);
...
export const btnSendEditAvatar = document.querySelector(
  ".form__btn-send-edit-avatar"
);
...
export const inputDescriptionAdd = document.querySelector(
  ".form__input_description-add"
);
...
export const popupDelete = new PopupDelete({
  modal: ".popup-delete",
  submitHandler: (id, target) => {
    //колбэк в попап подтверждения
